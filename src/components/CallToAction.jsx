export default function CallToAction() {
  return (
    <div
      className="container-fluid py-5 wow fadeIn callToAction "
      data-wow-delay="0.1s"
    >
        ...
        <div className="row g-5">
          <div className="col-md-8 col-xl-9">
            ...
            <p>
              ...
              navigate your visa and migration journey smoothly. Whether you are
              a student, a skilled worker, or someone looking for a long-term
