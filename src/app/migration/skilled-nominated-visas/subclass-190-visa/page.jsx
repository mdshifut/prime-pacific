    ...
    <>
      <Breadcrumb
        ...
        items={[
          ...
          { label: "Subclass 190 Visa", active: true },
        ]}
      />
      <FeatureContent
        subTitle="Subclass 190 Visa"
        title="Gain Australia Permanent Residency"
        description={[
          "Do you want to build a future in Australia? Do you need a Skilled Nominated Visa for permanent residency in Australia? It could be the subclass 190 visa if you’re skilled professional looking for PR. Unlike temporary work visas, this visa provides you with the opportunity to work and live permanently in Australia — and a pathway to citizenship. ",
        ]}
        img1="/permanent.jpg"
      />
        ...
        contentList={[
          {
            ...
            texts: [
              "The 190 skilled nominated visa is a points-based visa that allows skilled workers to live permanently in a nominated Australian state or territory.",
              "This Visa lets you live anywhere in Australia for an indefinite period and include eligible family members in your application. To be eligible, you must receive a nomination from a state or territory government. When you are, you’ll receive extra points in your overall immigration score — often the deciding factor in your chance of being invited to apply. ",
              "It is ideal for all those who may not qualify for other independent visas but still have skills which are required in accordance to Australia’s requirements.",
            ],
          },
          {
...
export default Subclass190Visa;
